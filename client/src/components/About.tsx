  ...
  const teamMembers = [
    {
      ...
      bio: "Started framing homes at 16; now oversees every project from bids to final walkthrough. With deep expertise in high-end residential construction, James ensures your project meets the highest standards of quality and craftsmanship.",
